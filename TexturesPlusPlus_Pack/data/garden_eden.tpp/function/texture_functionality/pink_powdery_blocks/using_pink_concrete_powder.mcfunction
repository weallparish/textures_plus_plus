advancement revoke @s only garden_eden.tpp:right_clicked_pink_concrete_powder
...
execute if score @s garden_eden.tpp.ray_success matches 1 as @e[name=garden_eden.tpp.raycast_location] at @s run function garden_eden.tpp:texture_functionality/pink_powdery_blocks/make_pink_powdery_block